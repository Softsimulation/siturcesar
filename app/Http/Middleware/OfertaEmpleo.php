...
class OfertaEmpleo
{
    ...
    if(strlen(strstr($request->path(),'ofertaempleo/agenciaviajes'))>0){
            ...
            if($encuesta->sitiosParaEncuesta->proveedor->categoria->id == 15 || $encuesta->sitiosParaEncuesta->proveedor->categoria->id == 13 || $encuesta->sitiosParaEncuesta->proveedor->categoria->id == 24 ){
