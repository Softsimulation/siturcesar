<?php $__env->startSection('title', 'Editar grupo de viaje'); ?>
...
<?php $__env->startSection('TitleSection', 'Editar grupo de viaje'); ?>

<?php $__env->startSection('Progreso', '0%'); ?>

<?php $__env->startSection('NumSeccion', '0%'); ?>

<?php $__env->startSection('controller','ng-controller="editar_grupo"'); ?>
