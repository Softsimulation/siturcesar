...
@section('meta_og')
<meta property="og:title" content="{{$vacante->nombre}}" />
...
@section('content')
    <div class="container">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-white justify-content-center">
            <li class="breadcrumb-item"><a href="/promocionBolsaEmpleo/vacantes">Bolsa de empleo</a></li>
            <li class="breadcrumb-item active text-truncate" aria-current="page">{{$vacante->nombre}}</li>
          </ol>
        </nav>
    ...
    <h2 class="text-center"><small class="d-block">Vacante</small>{{$vacante->nombre}}</h2>
    <hr>
    <div class="row">
