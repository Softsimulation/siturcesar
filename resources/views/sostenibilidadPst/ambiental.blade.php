    ...
    <form role="form" name="datosForm" novalidate>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.11 ¿Cuáles  áreas  protegidas promociona en el Cesar?</b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.12 ¿Qué  nivel  de  conocimiento  tienen  los  empleados  sobre  las  especies  de  flora  y  fauna  características  del Cesar? </b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P. 12.1 ¿Sabe si el Cesar tiene una guía que caracterice la flora, fauna y especies en vía de extinción para la conservación de los mismos? </b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.13 ¿La empresa adelanta o ha participado en alguna de las siguientes actividades para conservar el medio ambiente en el Cesar? </b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.15 De los siguientes riesgos o problemáticas ambientales en función del turismo sostenible, ¿Cuáles  cree  que  representan  un riesgo alto, medio o bajo en el Cesar?</b></h3>
            </div>
