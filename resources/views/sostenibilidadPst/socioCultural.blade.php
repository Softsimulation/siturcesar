...
<div class="container">
    ...
    <form role="form" name="datosForm" novalidate>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.2 ¿Cree que los turistas que llegan al Cesar respetan y conservan las tradiciones, monumentos, grupos étnicos y población residente en general?</b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.3 Con una calificación de alto, medio o bajo, ¿Cómo califica el nivel de conocimiento del personal de su empresa de los servicios, productos y atractivos culturales que ofrece el Cesar? </b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success" ng-if="encuesta.criterios_calificacion_id != 4 && encuesta.criterios_calificacion_id != undefined">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P. 3.1 ¿Ofrecen información oportuna a los visitantes sobre los servicios, productos y atractivos culturales que hay en el Cesar? </b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.9 De los siguientes riesgos o problemáticas socioculturales en función del turismo sostenible, ¿Cuáles considera que representan un riesgo alto, medio o bajo en el Cesar?</b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.10 ¿Cuál debería ser la contribución de turismo a  la conservación  de patrimonio  sociocultural del Cesar?</b></h3>
            </div>
            <div class="panel-footer"><b>Respuesta abierta</b></div>
            <div class="panel-body">
                <div class="row">
