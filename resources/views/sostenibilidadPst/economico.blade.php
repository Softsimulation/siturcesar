    ...
    <form role="form" name="datosForm" novalidate>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.23 Califique como positivos o negativos los impactos económicos del turismo en el Cesar? </b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.24 ¿Qué porcentaje de proveedores  de su  empresa son del Cesar ? Es decir, % de empresas locales que producen su bien o servicio en el Cesar.</b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.24.1 De  los  proveedores  establecidos  en el Cesar, por favor clasifíquelos de acuerdo al producto o servicio que suministran. </b></h3>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading p3">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> P.26 De los siguientes beneficios económicos que se generan por el turismo, ¿Cuáles cree que han mejorado o desmejorado en el Cesar?</b></h3>
            </div>
