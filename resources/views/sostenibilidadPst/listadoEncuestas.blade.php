...
@section('titulo','Encuestas de sostenibilidad de PST')
                ...
                <table class="table table-striped">
                    ...
                    <tr dir-paginate="item in encuestas|filter:prop.search |itemsPerPage:10 as results" pagination-id="paginacion_encuestas" >
                        <td>@{{$index+1}}</td>
                            ...
                            <td style="text-align: center;">@{{item.numeroSeccion}}</td>
                            <td style="text-align: center;">
                                <a href="/sostenibilidadpst/editarencuesta/@{{item.id}}" title="Editar encuesta" ng-if="item.EstadoId != 7 && item.EstadoId != 8" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-pencil"></span><span class="sr-only">Editar encuesta</span></a>
                            </td>
                    </tr>
                </table>
