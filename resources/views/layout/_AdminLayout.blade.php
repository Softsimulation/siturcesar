...
<head>
    ...
    <!--<link href="{{secure_asset('/css/bootstrap-material-design.css')}}" rel="stylesheet" type="text/css" />-->
    <link href="{{secure_asset('/css/ripples.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{secure_asset('/css/sweetalert.min.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{secure_asset('/css/ionicons.min.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{secure_asset('/css/styleLoading.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{secure_asset('/css/object-table-style.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{secure_asset('/css/ADM-dateTimePicker.min.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{secure_asset('/css/select.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{secure_asset('/css/select2.css')}}" rel='stylesheet' type='text/css' />
    <link href="{{secure_asset('/css/ADM-dateTimePicker.min.css')}}" rel="stylesheet" type="text/css" />
...
<body @yield('app')  @yield('controller') >
    ...
    <div id="preloader">
        <div>
            ...
            <img src="{{secure_asset('Content/image/logo.min.png')}}" width="200" />
        </div>
    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-md-2">
                        <img src="{{secure_asset('Content/image/logo.png')}}" alt="Logo" />
                    </div>
    ...
    <script src="{{secure_asset('/js/plugins/select.min.js')}}" type="text/javascript"></script>
    ...
    <script src="{{secure_asset('/js/ADM-dateTimePicker.min.js')}}" type="text/javascript"></script>
    <script src="{{secure_asset('/js/plugins/angular-sanitize.js')}}" type="text/javascript"></script>
    <script src="{{secure_asset('/js/plugins/object-table.js')}}" type="text/javascript"></script>
       
    <script src="{{secure_asset('/js/administrador/administrador.js')}}" type="text/javascript"></script> 
    <script src="{{secure_asset('/js/administrador/temporadas.js')}}" type="text/javascript"></script> 
    <script src="{{secure_asset('/js/administrador/services.js')}}" type="text/javascript"></script>
    <script src="{{secure_asset('/js/administrador/exportaciones.js')}}" type="text/javascript"></script> 
