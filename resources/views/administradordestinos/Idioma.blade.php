        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="form-group" ng-class="{'has-error': (editarDestinoForm.$submitted || editarDestinoForm.nombre.$touched) && editarDestinoForm.nombre.$error.required}">
                    ...
                    <input ng-model="destino.datosGenerales.nombre" required type="text" name="nombre" id="nombre" class="form-control" placeholder="Nombre del destino (Máximo 150 caracteres)"/>
