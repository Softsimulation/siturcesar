    ...
    <form role="form" name="GastoForm" novalidate>
        <!--<div class="panel panel-success">
            <div class="panel-heading">
                ...
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>  Seleccione los gastos realizados por usted antes (gastos de preparación del viaje al Cesar) y durante su viaje al Cesar</b></h3>
            </div>
        ...
        <div class="gastosRealizados">
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>E1. El viaje al Cesar hizo parte de un paquete/plan turístico o excursión</b></h3>
                </div>
                <div class="panel-footer"><b>Pregunta con selección única</b></div>
                <div class="panel-body">
                    <div class="row">
            ...
            <div class="ViajeDepartamento" ng-show="encuestaReceptor.ViajoDepartamento==1">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>E1.1 ¿El paquete/plan turístico incluyó municipios fuera del Cesar?</b></h3>
                    </div>
                    <div class="panel-footer"><b>Pregunta con selección única</b></div>
                    <div class="panel-body">
                        <div class="row">
                ...
                <div class="panel panel-success" ng-show="encuestaReceptor.IncluyoOtros==1">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>E1.1 ¿Qué otras ciudades/municipios fuera del Cesar incluyó el paquete/plan turístico?</b></h3>
                    </div>
        ...
        <div class="panel panel-success" ng-show="abrirTerrestre">
            <div class="panel-heading">
                ...
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span> E7.¿Cuál es el nombre de la empresa de transporte terrestre de pasajeros utilizado desde una ciudad de  Colombia a Cesar?</b></h3>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
        ...
        <div class="panel panel-success" ng-show="abrirRopa">
            <div class="panel-heading">
                <h3 class="panel-title"><b><span class="asterik glyphicon glyphicon-asterisk"></span>E9. En dónde fue realizado el mayor gasto de productos como ropa, calzado,  artesanías etc. (bienes duraderos) antes y durante el viaje a Cesar :</b></h3>
            </div>
            <div class="panel-footer"><b>Pregunta con selección única</b></div>
            <div class="panel-body">
                <div class="row">
